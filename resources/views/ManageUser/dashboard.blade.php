    ...
    <div class="row">
        <div class="card card-background col m-4">
            ...
            <div class="card-body">
                ...
                <p class="card-description mb-4">It appears that you haven't yet applied for Booth access. To streamline your experience and take advantage of our KIOSK services, please click the button below to register Booth.</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Booth Available</p>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Rentals</p>
                                    <h5 class="font-weight-bolder">
                                        {{$datas['rentals']}}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Application Received</p>
                                    <h5 class="font-weight-bolder">
                                        {{$datas['applications']}}
                                    </h5>
                                </div>
