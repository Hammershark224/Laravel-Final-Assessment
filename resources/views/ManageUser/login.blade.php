                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://online.fliphtml5.com/cnupv/xafp/files/large/102.jpg');
              background-size: cover;">
                                <span class="mask bg-gradient-secondary opacity-4"></span>
                                <h1 class="mt-5 text-white font-weight-bolder position-relative">UMPSA Pasar Malam Management System</h1>
