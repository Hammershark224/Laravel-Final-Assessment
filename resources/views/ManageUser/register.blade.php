            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome to PMMS!</h1>
                        <p class="text-lead text-white">Sign Up Here</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card z-index-0">
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <!-- ic input -->
                                <div class="flex flex-col mb-3">
                                    <input type="number" name="IC_number" class="form-control" placeholder="010101081021" aria-label="IC_number" value="{{ old('IC_number') }}">
                                    @error('IC_number') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>

                                <!-- username input -->
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="username" class="form-control" placeholder="Full Name" aria-label="Name" value="{{ old('username') }}" >
